...
Class PessoaDAO extends DAO{
    ...
    na tabela pessoa. Ele cria uma conexão com o banco de dados, 
    monta a instrução SQL de inserção usando os dados do objeto 
    $pessoa, executa a consulta e fecha a conexão. O resultado da 
    execução da consulta é retornado.
    */
